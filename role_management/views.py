...
class adminView(View):
    ...
    def get(self, request):
         ...
         if current_user.is_superuser:
          ...
          admins = users.objects.filter(parent_id=current_user.id, roles__role_name="ADMIN").order_by('-id')
    ...
    def post(self, request):
        ...
        try:
            ...
            if admin_id:
                ...
                print('===id,email,username,email,firstname,lastname======',email,first_name,last_name)
